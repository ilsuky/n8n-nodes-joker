...
class BinaryDataFileSystem {
    ...
    async deleteBinaryDataByExecutionId(executionId) {
        ...
        const filenames = await fs_1.promises.readdir(path.join(this.storagePath));
    ...
    async saveToLocalStorage(data, identifier) {
        await fs_1.promises.writeFile(path.join(this.storagePath, identifier), data);
    }
