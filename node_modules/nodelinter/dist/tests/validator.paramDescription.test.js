...
describe("Validator should validate param description values", function () {
    var lintArea = "paramDescription";
    ...
    testHelpers_2.lintingsByGroup[lintArea].forEach(testHelpers_1.runTest(validator));
});
