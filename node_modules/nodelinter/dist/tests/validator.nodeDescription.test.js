...
describe("Validator should validate node description", function () {
    var lintArea = "nodeDescription";
    ...
    var sourceFilePathNodeTs = testHelpers_1.validatorMockFilePath("nodeDescription.node.ts");
    ...
    var _a = __read(testHelpers_1.separateCheckCredTestFunctions(testHelpers_2.lintingsByGroup[lintArea]), 2), checkCredTestFunctions = _a[0], others = _a[1];
    testHelpers_1.runTest(validatorNodeTs)(checkCredTestFunctions);
